 ...
 * @package Itb
 */
class LookUpReferenceRepositoryUnavailableReasons extends ReadOnlyDatabaseTableRepository
{
    public function __construct()
    {
        $namespace = 'Itb\Model';
        $classNameForDbRecords = 'LookUpReference';
        $tableName = 'employeeunavailablereasons';// counties is an SQL view filtered on the lookupreference table to only extract roster status values
