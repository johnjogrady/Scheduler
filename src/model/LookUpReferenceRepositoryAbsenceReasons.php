 ...
 * @package Itb
 */
class LookUpReferenceRepositoryAbsenceReasons extends ReadOnlyDatabaseTableRepository
{
    public function __construct()
    {
        $namespace = 'Itb\Model';
        $classNameForDbRecords = 'LookUpReference';
        $tableName = 'employeeabsencereasons';// counties is an SQL view filtered on the lookupreference table to only extract roster status values
